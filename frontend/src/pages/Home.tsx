...
function getTimelineIcon(event:any) {
...
// Data for sections is now defined outside the component for better performance.
// This prevents recreation on every re-render.
const SKILLS_DATA = [
  {
    icon: Code,
...
// Define types for better IntelliSense and type-safety.
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-20 pb-16 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        {/* Moved floating divs to a separate component or styled-component for better organization in a larger project */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed animate-slide-up animate-stagger-1">
              <DecryptedText
                text="Transforming data into intelligent insights through cutting-edge technologies and innovative AI solutions. Building the future, one algorithm at a time."
                speed={50}
                maxIterations={20}
                sequential={true}
                revealDirection="start"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6 animate-slide-up animate-stagger-2">
            <Link to="/projects" className="btn-modern inline-flex items-center hover-lift pulse-glow">
              View Projects
              <ArrowRight className="w-5 h-5 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
            <Link to="/demos" className="btn-secondary hover-lift glass-effect">
              Try AI Demos
            </Link>
          </div>
              ...
              <div className="relative z-10">
                <div className="bg-gradient-to-br from-cyan-500/10 via-blue-500/10 to-purple-500/10 rounded-3xl p-8 border border-cyan-200/20 dark:border-cyan-800/20 backdrop-blur-sm">
                  ...
                  <div className="space-y-4">
                    <a href="mailto:divyanshhdubey10@gmail.com" className="flex items-center justify-center space-x-3 p-3 bg-white/30 dark:bg-gray-800/30 rounded-xl backdrop-blur-sm hover:scale-105 transition-transform duration-300">
                      <Mail className="w-5 h-5 text-cyan-500" />
                      <span className="text-gray-700 dark:text-gray-300">divyanshhdubey10@gmail.com</span>
                    </a>
                    <a href="tel:+918368959173" className="flex items-center justify-center space-x-3 p-3 bg-white/30 dark:bg-gray-800/30 rounded-xl backdrop-blur-sm hover:scale-105 transition-transform duration-300">
